<template>
    <div
        class="bg-white dark:bg-primary-600 rounded shadow h-full flex flex-col"
    >
        <div class="p-4 flex flex-col flex-1 justify-start">
            <div class="flex justify-between pb-2">
                <h1 class="font-semibold text-xl dark:text-primary-200">
                    {{ group.name }}
                </h1>
                <div
                    class="flex items-center gap-1 text-primary-400 dark:text-primary-200"
                >
            ...
            <div class="flex justify-around mt-3">
                <div>
                    ...
                    >
                        <CircleUser
                            class="h-3.5 inline fill-current"
                        ></CircleUser>
