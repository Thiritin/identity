        ...
        <form class="space-y-12" @submit.prevent="submit">
            ...
            <div class="space-y-4">
                <div class="space-y-2">
                    ...
                    <FormInput id="email" v-model.trim.lazy="form.email" :class="{
                ...
                <div class="space-y-2">
                    ...
                    <FormInput id="password" v-model.lazy="form.password" :class="{
                            'border-red-500 focus:ring-red-500':
                                errors?.password != null,
                        }" :placeholder="$trans('password')" autocomplete="password" class="mb-16" type="password"/>
                </div>
            </div>
            <div class="flex flex-col">
                <button :class="
                    ...
                    " :disabled="form.processing" class="
                        py-3 rounded-lg px-12 ml-auto text-white text-2xl mb-4 font-semibold focus:outline-none
                    " type="submit">
                    {{ $trans('sign_in') }}
                </button>
