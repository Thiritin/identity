...
const theme = ref<MessagePassThroughOptions>({
    root: `rounded-md outline outline-1
        ...
        p-info:bg-primary-50/95 p-info:outline-primary-200 p-info:text-primary-600 dark:p-info:bg-primary-500/15 dark:p-info:outline-primary-700/35 dark:p-info:text-primary-500
        p-info:p-outlined:text-primary-500 p-info:p-outlined:outline-primary-500 dark:p-info:p-outlined:text-primary-600 dark:p-info:p-outlined:outline-primary-600
        p-info:p-simple:text-primary-500 dark:p-info:p-simple:text-primary-600
    ...
    closeButton: `flex items-center justify-center flex-shrink-0 ms-auto overflow-hidden relative cursor-pointer select-none
        ...
        p-info:hover:bg-primary-100 p-info:focus-visible:outline-primary-600 dark:p-info:hover:bg-white/5 dark:p-info:focus-visible:outline-primary-500
