<template>
    <svg aria-hidden="true" focusable="false" data-prefix="fad" data-icon="ticket"
         class="svg-inline--fa fa-ticket fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
        <g class="fa-group">
